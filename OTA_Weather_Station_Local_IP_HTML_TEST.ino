...
// Version 1.4 - first compile 27/07/2020
// This code version works for IoT weather station: BME280/Anemometer/ESP8266 Over the air programming
// Hardware interrupt on pin D7 for anemometer and SDK timer interrupt for calculating windSpeed in
// calculateWS()
// This version uses ESPWebserver to send string/html to local IP
