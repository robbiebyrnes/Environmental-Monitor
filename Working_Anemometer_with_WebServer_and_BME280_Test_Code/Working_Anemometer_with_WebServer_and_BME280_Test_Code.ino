...
float temperature, humidity, pressure, altitude; // floating double data tyoes for storing sensor readings

// Setting up ESP8266 in Statoin Mode: Put your SSID & Password
const char* ssid = "NOWTVDEXXI";  // Enter SSID here
const char* password = "kF4QMhzc3xcS";  //Enter Password here
ESP8266WebServer server(80); // com port 80 
...
void setup ()
{
  ...
  // Connect to your local wi-fi network as a station
...
String SendHTML(float temperature,float humidity,float pressure,float altitude){
  ...
  ptr +=temperature; //add (int) after += to change to int
  ...
  ptr +="<div class='side-by-side reading'>";
  ptr +=humidity; //add (int) after += to change to int
  ...
  ptr +="<div class='side-by-side reading'>";
  ptr +=pressure; //add (int) after += to change to int
  ...
  ptr +="<div class='side-by-side reading'>";
  ptr +=(int)altitude; //add (int) after += to change to int
