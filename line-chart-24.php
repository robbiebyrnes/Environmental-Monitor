...
if($stmt = $connection->query("SELECT reading_time, Temperature, Humidity ,WindSpeed, ID FROM SensorData WHERE reading_time >= now() - INTERVAL 1 DAY ORDER BY reading_time")){
